export const plantationRoutesDocs = {
  createPlantation: {
    ...
    description:
      "Essa rota permite criar uma nova plantação para o usuário autenticado.",
    body: {
      type: "object",
      properties: {
        name: {
  ...
  deletePlantation: {
    ...
    description:
      "Essa rota permite deletar uma plantação específica do usuário autenticado.",
    params: {
      type: "object",
      properties: {
        id: {
  ...
  getPlantations: {
    ...
    description:
      "Essa rota retorna todas as plantações associadas ao usuário autenticado.",
    response: {
      200: {
