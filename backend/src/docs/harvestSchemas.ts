export const harvestRoutesDocs = {
  createHarvest: {
    ...
    description: 'Registra uma nova colheita vinculada a uma plantação do usuário autenticado.',
    body: {
      type: 'object',
      properties: {
  ...
  getHarvestsByPlantation: {
    ...
    description: 'Retorna todas as colheitas registradas para uma plantação específica.',
    params: {
      type: 'object',
      properties: {
        plantationId: { type: 'string', format: 'uuid' },
